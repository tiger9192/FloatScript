...
export function env(env: string) {
    if (env === 'PREVIEW')
        ...
        return {
            ...
            urlLiquidityPair: 'https://liquidity-pair-preprod.dev.tekoapis.net',
            yieldUrl: '',
        ...
        return {
            ...
            urlMonitor: 'https://loan-monitoring.api.danogo.io',
            urlLiquidityPair: '',
        ...
        return {
            ...
            urlMonitor: 'https://loan-monitoring.tekoapis.com',
            urlLiquidityPair: 'https://liquidity-pair-indexer.tekoapis.com',
            yieldUrl: 'https://yield-aggregator.tekoapis.com/',
